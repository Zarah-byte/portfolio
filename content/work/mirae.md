---
eyebrow: Mirae
title: Sensing what the body knows before the mind does
team: Zarah Yaqub & Chareese Lam
context: FigBuild 2026
tools: Figma, Figma Make, After Effects, Jitter, Kling AI, ChatGPT, Claude
year: 2026
order: 0
tags: ["Speculative", "Wearable", "AI"]
hero: ../assets/media/mirae/cover.png
heroType: image
caption: Mirae — FigBuild 2026
---
...
[image:../assets/media/mirae/patch.png The Mirae sensing patch — a soft, transparent wearable with an embedded chip flush]
...
1. Refining the sensing logic behind how internal states are detected
2. Expanding the AI guidance system to adapt across different emotional and behavioral contexts
3. Deepening the research into interoception, neuroplasticity, and habit change
