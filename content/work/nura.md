...
hero: ../assets/media/covers/nura-cover.png
heroType: image
caption: Nura, 2024
---
...
[placeholder: Problem framing — care that falls between appointments, not inside them]
...
[placeholder: The reframe — caregiver load first, patient data as a byproduct of a gentler routine]

## Solution

[deck] Soft edges, honest data.
...
[placeholder: Product overview — the calm surface over a rigorous data layer]

[card: Gentle prompts | One thing to remember at a time, surfaced as a soft prompt rather than an alert stack. Nura asks for less, more kindly.]
...
[placeholder: Morning — the day's routine surfaced as a single gentle prompt]
...
[placeholder: Midday — a medication check-in as a light touch, not a red alarm]
...
[placeholder: Foundations — type, color, and components tuned to lower the temperature]
...
[card: Caregiver first, patient second | The organizing decision: center the caregiver's load and let the patient's data fall out of a gentler routine.]
[card: No alarms, only prompts | Alerts and red badges were cut in favor of soft, single prompts, so the app never raises the temperature of a hard day.]
[card: No streaks, no scolding | Gamified consistency was removed. A missed task is met with a next step, never a broken streak or a guilt cue.]
[card: Gentle without going soft | Plain language and warm forms sit on top of rigorous, structured data, so kindness never costs clinical usefulness.]
...
[card: A companion, not a tracker | The language caregivers reached for changed, from a tool they had to feed to a presence that helped carry the day.]
[card: Consistency without pressure | The design made space for the emotional weight of the work, not just the logistics, and held routine without demanding it.]
[card: Rigor and gentleness together | Nura became proof that clean, clinical-grade data and a gentle tone don't have to trade off against each other.]
...
[deck] The hardest choices were about what to leave out.

[card: Designing for the invisible person | Caring for the caregiver meant designing for needs that are usually invisible in health tools, and trusting that as the primary job.]
[card: Restraint as the real work | The strongest moves were subtractions. Deciding what not to build kept Nura calm enough to actually live with.]
