...
[image:../assets/media/tasks/in-hand.png Google Tasks today — one undifferentiated stream flush]
...
[image:../assets/media/tasks/competitors.png Competitor audit — Apple Reminders and TickTick flush]
...
[image:../assets/media/tasks/google-audit.png The shared Google pattern — Calendar and Gmail flush]
...
[image:../assets/media/tasks/consistency.png Before and after aligning Tasks with Google's design language flush]
...
[image:../assets/media/tasks/organize-views.png The same tasks organized by list, then by due date flush]

[image:../assets/media/tasks/sort-on-demand.png An organized list, with sorting on demand through Google's own menu pattern flush]
...
[image:../assets/media/tasks/swipe-complete.png Swipe to complete a task flush]

[image:../assets/media/tasks/move-task.png Dragging a task from one list to another flush]
