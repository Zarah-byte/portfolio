(function () {
	...
	/* Thin ↗ for external Resume — matches the reference strip. */
	const EXTERNAL_ARROW_SVG = '<svg class="site-menu__external-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false"><path d="M7 17L17 7M17 7H9M17 7V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';

	const PAGES = [
		{ id: 'work', label: 'Work', href: 'index' },
		{ id: 'play', label: 'Archive', href: 'play' },
	...
	function build(current, compact) {
		...
		// One strip: Work / Archive / About / Resume↗
		...
		resume.className = 'site-menu__link site-menu__link--external';
		resume.href = '/resume/Zarah_Yaqub_Resume.pdf';
		resume.target = '_blank';
		resume.rel = 'noopener noreferrer';
		resume.innerHTML = `<span>Resume</span>${EXTERNAL_ARROW_SVG}`;
		primary.append(resume);
