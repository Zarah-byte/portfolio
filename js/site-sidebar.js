	...
	function buildSidebar() {
		...
		aside.innerHTML = `
			<div class="side-header">
				<a href="${prefix}index.html" class="wordmark" aria-label="Zarah Yaqub — home">
				...
				<ul class="socials">
					<li>
						<a href="mailto:zarahyaqubdesign@gmail.com" class="social">
							<img src="${prefix}assets/icons/email.svg" alt="" class="social-icon" width="40" height="40">
							<span class="visually-hidden">Email</span>
						</a>
					</li>
					<li>
						<a href="https://www.linkedin.com/in/zarahbydesign" class="social" target="_blank" rel="noopener noreferrer">
							<img src="${prefix}assets/icons/linkedin-svgrepo-com 1.svg" alt="" class="social-icon" width="40" height="40">
							<span class="visually-hidden">LinkedIn</span>
						</a>
					</li>
					<li>
						<a href="https://github.com/Zarah-byte" class="social" target="_blank" rel="noopener noreferrer">
							<img src="${prefix}assets/icons/github-rounded-svgrepo-com 1.svg" alt="" class="social-icon" width="40" height="40">
