...
<Deck>AI is everywhere, and still waiting to be asked.</Deck>
...
<Image src="/assets/media/iris/problem.jpg" alt="Problem space" flush />

<Deck>The prompt is the problem.</Deck>
...
<Deck>An agent that reads the moment instead of waiting to be summoned.</Deck>
...
<Image src="/assets/media/iris/solution.jpg" alt="Solution" flush />

## Design Process

<Deck>To make this real, we followed one person through their day.</Deck>
...
<Vimeo id="1182454088" title="Airport 01" />

<Vimeo id="1182454079" title="Airport 02" ratio="10000x5299" />
...
<Vimeo id="1182454097" title="Gym 1" />

<Vimeo id="1182454109" title="Gym 2" />

<Deck>How do you design something that isn't meant to be noticed?</Deck>
...
<Gallery>
  <Image src="/assets/media/iris/design-system-01.jpg" alt="Glasses interface" flush />
  <Image src="/assets/media/iris/design-system-02.jpg" alt="System status" flush />
</Gallery>

<Image src="/assets/media/iris/design-system-transition.gif" alt="Interface transition" flush />

## Results

<Deck>A bet on where intelligent interfaces are heading next.</Deck>
...
<Image src="/assets/media/iris/team-photo.jpg" alt="Team photo" flush />

## Reflection

<Deck>Strong vision beats strong visuals.</Deck>
