...
- **Per-page first viewports** — home prose, about bio+portrait, play giant
  title (weight 700), project masthead (weight 400). Do not collapse to one hero.
...
| `about.html` | `page-about` | `about.css` | Prose + portrait; `<strong>` hover-images |
